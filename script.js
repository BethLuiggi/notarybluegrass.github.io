...
$('calcMilesBtn').addEventListener('click',function(){
  ...
  var HOME_LAT=37.6951, HOME_LON=-85.8697;
  ...
  function render(mi, isApprox){
    if(mi>150){
      showError('&#9888; This address is approximately '+mi+' miles away &mdash; well outside our usual service area. Please call <a href="tel:2703080260" style="color:var(--gold);text-decoration:underline;">(270) 308-0260</a> to confirm we can serve this location.');
      return;
    }
    ...
    if(mi<=25){
      ...
      var ex=mi-25;
      bk.milesFee=ex*2;
      res.innerHTML='<span style="color:#c9a84c;font-size:.85rem;font-weight:700;">&#128205; '+mi+' miles'+tag+' &mdash; '+ex+' beyond 25 = <strong>+$'+bk.milesFee+' travel fee</strong></span>';
    }
    btn.disabled=false; btn.textContent='Recalculate';
  }
