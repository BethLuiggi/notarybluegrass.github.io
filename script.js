var SK='pk_test_51TBehPDMcmmj7Vo6ok4Z3EAuehsnKXlwrlKi6lgmuiX99umNiX8P2k5FvUvwsfZqf3gWA3BajJRcsSuXltWgSAw400yHHX2W0H';
  ...
  if(!stripe){
    ...
    s.onload=function(){
      try{
        ...
        $('card-element').innerHTML='<div style="color:#e53e3e;font-size:.85rem;padding:.5rem;">Card form failed to load. Please refresh the page or contact us at (270) 308-0260.</div>';
      }
    };
    s.onerror=function(){
      console.error('Stripe.js failed to load — likely blocked by an ad blocker or privacy extension.');
      $('card-element').innerHTML='<div style="color:#e53e3e;font-size:.85rem;padding:.5rem;">Secure card processor blocked. If you use an ad blocker, please disable it for this site, or call us at (270) 308-0260 to book by phone.</div>';
    };
    document.head.appendChild(s);
  }
}
