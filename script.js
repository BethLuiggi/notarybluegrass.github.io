...
$('calcMilesBtn').addEventListener('click',function(){
  ...
  .then(function(data){
    ...
    var destLat=parseFloat(data[0].lat), destLon=parseFloat(data[0].lon);
  ...
  .catch(function(err){
    ...
    res.innerHTML='<span style="color:#856404;font-size:.82rem;">&#9888; Could not look up that address. Travel fee will be confirmed at signing.</span>';
    btn.disabled=false; btn.textContent='Recalculate';
  });
});
